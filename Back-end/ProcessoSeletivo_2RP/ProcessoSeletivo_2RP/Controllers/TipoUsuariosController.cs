    ...
    public class TipoUsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoUsuarios != null ? 
                          ...
                          Problem("Entity set 'Contexto.TipoUsuarios'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdTipoUsuario,TituloTipoUsuario")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTipoUsuario,TituloTipoUsuario")] TipoUsuario tipoUsuario)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.TipoUsuarios'  is null.");
            }
            var tipoUsuario = await _context.TipoUsuarios.FindAsync(id);
            if (tipoUsuario != null)
            {
